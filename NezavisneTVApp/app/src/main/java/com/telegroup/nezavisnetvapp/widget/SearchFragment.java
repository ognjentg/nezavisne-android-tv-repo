...
public class SearchFragment extends android.support.v17.leanback.app.SearchFragment
    ...
    private final CursorObjectAdapter mVideoCursorAdapter =
            new CursorObjectAdapter(new NewsCardPresenter());
                    ...
                    default:
                        ...
                        if (FINISH_ON_RECOGNIZER_CANCELED) {
                            if (!hasResults()) {
                                ...
                                getView().findViewById(android.support.v17.leanback.R.id.lb_search_bar_speech_orb).requestFocus();
                            }
                        }
                        break;
                }
    ...
    public void focusOnSearch() {
        getView().findViewById(android.support.v17.leanback.R.id.lb_search_bar).requestFocus();
    }
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof NewsCard) {
                NewsCard article = (NewsCard) item;
